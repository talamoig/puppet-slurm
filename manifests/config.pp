...
class slurm::config (
  ...
  Optional[Enum['checkpoint/blcr','checkpoint/none','checkpoint/ompi','checkpoint/poe']] $checkpoint_type = undef,
  Optional[String] $chos_loc = undef,
  Optional[Array]  $communication_parameters = undef,
  ...
  Optinal[Array[String]] $task_plugin_param = undef,
